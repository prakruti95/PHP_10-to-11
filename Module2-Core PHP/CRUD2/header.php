            ...
            <div class="container">
               <div class="row d_flex">
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon">
                        <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i> Call Us : +919724004242</a> </li>
                     </ul>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon ">
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i> tops@gmail.com</a> </li>
                     </ul>
                  </div>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-md-9 col-sm-7">
                   ...
                   <div class="col-md-3 col-sm-5 d_none">
                     ...
                     <a class="swd-button" href="signup.php">sign up </a>
                     <a class="swd-button" href="signin.php">sign in </a>
                   </div>
